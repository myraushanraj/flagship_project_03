                        ...
                        <div className="de-flex">
                            <div className="de-flex-col">
                                <span onClick={() => window.open("", "_self")}>
                                    <span className="copy">&copy; Copyright © 2023. All rights reserved by Flagship</span>
                                </span>
                            </div>
                            <div className="de-flex-col">
                                <div className="social-icons">
                                    <span><a href="https://www.facebook.com/flagshipclubofficial" target="_blank"><i className="fa fa-facebook fa-lg"></i></a></span>
                                    <span><a href="https://twitter.com/FlagshipClub" target="_blank"><i className="fa fa-twitter fa-lg"></i></a></span>
                                    <span><a href="https://www.linkedin.com/company/flagshipclub/" target="_blank"><i className="fa fa-linkedin fa-lg"></i></a></span>
                                    <span><a href="https://www.youtube.com/@flagshipclub" target="_blank"><i className="fa fa-youtube-play fa-lg"></i></a></span>
                                    <span><a href="https://www.instagram.com/flagshipclub_official/" target="_blank"><i className="fa fa-instagram fa-lg"></i></a></span>
